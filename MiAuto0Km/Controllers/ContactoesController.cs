...
namespace MiAuto0Km.Controllers
{
    public class ContactoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Contacto,Nombre,Email,Telefono,Asunto,Comentario")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Contacto,Nombre,Email,Telefono,Asunto,Comentario")] Contacto contacto)
        {
            if (ModelState.IsValid)
            {
